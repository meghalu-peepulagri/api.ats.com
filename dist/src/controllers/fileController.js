...
class FileController {
    getUploadURL = async (c) => {
        ...
        if (!validatedReq.success) {
            throw new UnprocessableContentException(UPLOAD_FILE_VALIDATION_CRITERIA, getValidationErrors(validatedReq.error.issues));
        }
    ...
    getDownloadURL = async (c) => {
        ...
        if (!validatedReq.success) {
            throw new UnprocessableContentException(DOWNLOAD_FILE_VALIDATION_CRITERIA, getValidationErrors(validatedReq.error.issues));
        }
